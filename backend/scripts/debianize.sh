...
PKGNAME=smartmeter-datacollector-configurator
...
dh_make -y --single --createorig --templates "${WORK_DIR}/debian-tmpl" --copyright bsd --packagename "${PKGNAME}_${PKGVERSION}"
